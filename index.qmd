...
pgm1 = daft.PGM(dpi=150, alternate_style="outer")

pgm1.add_node("lemons", "Lemons", 1, 1, aspect=3, scale=1.1,
             plot_params={
                 'facecolor': 'yellow', 
...
pgm1.add_node("scurvy", "Scurvy", 3.5, 1, aspect=3, scale=1.1,
             plot_params={
...
```
#### Understanding 
- Shows the observed relationship (lemons prevent scurvy)
- But doesn't explain WHY it works
- Limitation: Without understanding mechanism, easy to make mistakes
...
pgm2.add_node("acid", "Acid", 1, 3, aspect=3, scale=1.1,
             plot_params={
...
pgm2.add_node("bacteria", "Bacteria", 2, 2, aspect=3, scale=1.1,
             plot_params={
                 'facecolor': 'rosybrown', 
                 'edgecolor': 'darkred', 
                 'linewidth': 2,
...
pgm2.add_node("scurvy", "Scurvy", 3, 1, aspect=3, scale=1.1,
             plot_params={
                 'facecolor': 'mistyrose', 
                 'edgecolor': 'firebrick', 
                 'linewidth': 2,
...
#### Understanding 
- Shows an incorrect causal model
- Demonstrates danger of wrong assumptions
- Led to failed interventions (using vinegar instead of lemons)
- Real-world consequence: Scurvy returned and killed thousands
...
pgm3.add_node("vitamin_c", "Vitamin C", 1, 3, aspect=3, scale=1.1,
             plot_params={
...
pgm3.add_node("collagen", "Collagen\nSynthesis", 2.5, 2, aspect=3, scale=1.1,
             plot_params={
...
pgm3.add_node("scurvy", "Scurvy", 4, 1, aspect=3, scale=1.1,
             plot_params={
...
pgm3.add_edge("vitamin_c", "collagen")
...
#### Understanding 
- Shows the true causal mechanism
- Explains why the treatment works
- Enables reliable, generalizable solutions
- Can now find Vitamin C in ANY source (not just lemons)
