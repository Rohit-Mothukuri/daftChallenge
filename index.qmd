...
# DAG 2: The Misguided Belief - Acid kills bacteria (VERTICAL LAYOUT)
pgm2 = daft.PGM(dpi=150)

# Add nodes for the incorrect causal chain - arranged vertically (top to bottom)
pgm2.add_node("acid", "Acid", 2, 3, aspect=2.5, scale=1.2,
             plot_params={
...
pgm2.add_node("scurvy", "Scurvy", 2, 1, aspect=2.5, scale=1.2,
             plot_params={
